...
def when_teach():
    ...
    def firstphoto():
        ...
        file=(r"C:/Users/acer/Desktop/folder/{}/img_black_01"+".jpg").format(E1.get())   #file name 
    ...
    def secondphoto():
        ...
        image=Image.fromarray(edges)
        file=(r"C:/Users/acer/Desktop/folder/{}/img_black_02"+".jpg").format(E1.get())
        cv2.imwrite(file,edges)
    ...
    def thirdphoto():
        ...
        image=Image.fromarray(edges)
        file=(r"C:/Users/acer/Desktop/folder/{}/img_black_03"+".jpg").format(E1.get())
        cv2.imwrite(file,edges)

    def fourthphoto():
        bt4=Button(window,image=four1,border=0,bg="white",command=lambda :[fourdone(),estimate_result()])
        bt4.place(relx=0.061,rely=0.67,relwidth=0.06,relheight=0.08)
        image=Image.fromarray(edges)
        file=(r"C:/Users/acer/Desktop/folder/{}/img_black_04"+".jpg").format(E1.get())
        cv2.imwrite(file,edges)
    ...
    def estimate_result():
        ...
        NonBP=[]
        i=2
        path = (r"C:/Users/acer/Desktop/folder/{}/*.*").format(E1.get())
        #path = ("/home/pi/test-repo/train/*.*")
        for a in glob.glob(path):
            photo1 = cv2.imread("{E1.get()}/img_black_01.jpg",0)
            photo_all = cv2.imread("{E1.get()}/img_black_0"+str(int(i))+".jpg",0)          
            if photo1.shape==photo_all.shape:
                #cv2.imshow("first pic",photo1)
                #cv2.waitKey(0)
                print(i,"st pass")
        ...
        photo2 = cv2.imread("{E1.get()}/img_black_02.jpg",0)
        photo3 = cv2.imread("{E1.get()}/img_black_03.jpg",0)
    ...
    def create_option():
        newpath = r"C:\Users\acer\Desktop\folder\{}".format(E1.get())
...
def whenopen():
    ...
    Le1 = Label(window2, text="Make a folder")
    Le1.place(relx=0.04,rely=0.40,relwidth=0.13,relheight=0.09)
    E1 = Entry(window2,bd=5)
    E1.place(relx=0.04,rely=0.90,relwidth=0.13,relheight=0.09)
    ...
    def testing():
        ...
        if imggrayed.shape == template.shape:
            ...
            if test_hub_live > 3336.48464:
                circlee= PhotoImage(file="accept1.png")
            ...
            elif test_hub_live < 3222.51535:
                print("hello")
                circle2=PhotoImage(file="reject1.png")
