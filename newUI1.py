...
def when_teach():
    ...
    def estimate_result():
        ...
        for a in glob.glob(path):
            photo1 = cv2.imread("/folder/{E1.get()}/img_black_01.jpg",0)
            photo_all = cv2.imread("/folder/{E1.get()}/img_black_0"+str(int(i))+".jpg",0)          
        ...
        with open("4.csv","w",newline="") as file:
...
def whenopen():
    ...
    def choosethefolder():
        ...
        fla=filedialog.askdirectory(initialdir="C:/Users/acer/Desktop")
        print(fla)
